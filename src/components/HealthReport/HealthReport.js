...
const HealthReportWrapper = Styled.div`
	margin: auto;
  text-align: center;
  max-width: 480px;
  margin-bottom:40px;
...
function HealthReport({ title, body, before_image, after_image, label }) {
	return (
		<HealthReportWrapper>
			...
			<div className="report__image-container">
				<div>
					...
					{before_image && before_image.childImageSharp && (
				...
				<div>
					...
					{after_image && after_image.childImageSharp && (
